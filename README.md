# ESCVehicle
ESCVehicle: A Drone-based Visible-Infrared Vehicle Benchmark with Extensive Scene Coverage [(paper)](https://ieeexplore.ieee.org/document/11358942)
...
- [Baidu Yun](https://pan.baidu.com/s/10FohmJOhSFPKFAdvSu5Tlg?pwd=1109)


## Citation
If you use this data for your research, please consider citing:
```
@article{song2026escvehicle,
  author={Song, Jiamin and Zhang, Nan and Wang, Zhenhao and Tian, Tian},
  journal={IEEE Transactions on Geoscience and Remote Sensing}, 
  title={ESCVehicle: A Drone-Based Visible–Infrared Vehicle Benchmark With Extensive Scene Coverage}, 
  year={2026},
  volume={64},
  pages={1-16},
  doi={10.1109/TGRS.2026.3655959}}
```

related work:
```
@article{zhang2025omni,
  title={Omni-Scene Infrared Vehicle Detection: An Efficient Selective Aggregation approach and a unified benchmark},
  author={Zhang, Nan and Chai, Borui and Song, Jiamin and Tian, Tian and Zhu, Pengfei and Ma, Jiayi and Tian, Jinwen},
...
This dataset is independently collected and annotated by the authors for research purposes only.
All data are obtained from publicly accessible environments.

If any content in this dataset is found to involve privacy concerns or potential infringement, please contact the authors promptly. We will take immediate actions, including modification or removal of the relevant data.

If you have any other questions or suggestions, please feel free to contact us. 

Email to: [Jiamin Song](mailto:sjm2001@hust.edu.cn) or [Tian Tian](mailto:ttian@hust.edu.cn) or [Zhenhao Wang](mailto:18863621407@163.com).
